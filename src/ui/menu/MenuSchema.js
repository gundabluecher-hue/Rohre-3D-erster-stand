...
function createPanelSchema(featureFlags) {
    return [
        ...
        },
        {
            ...
            settingsDomain: 'matchSettings',
            stepper: [
                { id: 'custom-step-mode', label: 'Spieltyp', panelId: 'submenu-game' },
                { id: 'custom-step-rules', label: 'Regeln', panelId: 'submenu-settings' },
                { id: 'custom-step-controls', label: 'Steuerung', panelId: 'submenu-controls' },
                { id: 'custom-step-profiles', label: 'Profile', panelId: 'submenu-profiles' },
            ],
        },
        {
